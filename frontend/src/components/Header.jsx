          ...
          <div className="md:ml-auto md:mr-auto pt-1 md:pl-14 pl-1 flex flex-wrap items-center md:text-base text-1xl md:justify-center justify-items-start">
           ...
           to={'/'} className="mr-11 pr-2 cursor-pointer text-gray-300 hover:text-white font-semibold transition duration-400">
            ...
            <div className="relative">
              ...
              >
                <span className="transition duration-400">Utilities</span>
                <svg
                  className={
                    flyer === true
              ...
              <div
                ...
                className={
                  flyer
                    ? "opacity-100 translate-y-0 transition ease-out duration-200 absolute z-10 -ml-4 mt-3 border-[#302f30] border transform px-2 w-screen max-w-sm sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-1/2"
